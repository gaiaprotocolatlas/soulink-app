        ...
        if (this.address !== ethers_1.constants.AddressZero) {
            ...
            if (address === undefined) {
                ...
                if (balance.eq(0)) {
                    ...
                    this.profile.append(new skydapp_browser_1.ResponsiveImage("img", "/images/default-profile.png"), (0, skydapp_browser_1.el)(".add", (0, skydapp_browser_1.el)("i.fa-solid.fa-plus")), (0, skydapp_browser_1.el)("input.name", {
                        placeholder: "NAME",
                        value: this.bio.name,
