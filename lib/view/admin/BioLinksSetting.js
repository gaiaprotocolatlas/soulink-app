    ...
    showLinks() {
        if (this.linkContainer !== undefined) {
            ...
            for (const link of AdminLayout_1.default.current.bio.links) {
                const linkDisplay = (0, skydapp_browser_1.el)(".link", (0, skydapp_browser_1.el)("input", { value: link.title, placeholder: "Title" }, { keyup: (event) => link.title = event.target.value }), (0, skydapp_browser_1.el)("input", { value: link.url, placeholder: "Url" }, { keyup: (event) => link.url = event.target.value }), (0, skydapp_browser_1.el)("a", "Delete", {
                    click: () => {
