...
exports.DiscountDBV0__factory = void 0;
...
class DiscountDBV0__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.DiscountDBV0__factory = DiscountDBV0__factory;
DiscountDBV0__factory.bytecode = _bytecode;
DiscountDBV0__factory.abi = _abi;
