    ...
    showLinks() {
        if (this.linkContainer !== undefined) {
            ...
            for (const link of AdminLayout_1.default.current.bio.links) {
                this.linkContainer.append((0, skydapp_browser_1.el)(".link", (0, skydapp_browser_1.el)("input", { value: link.title, placeholder: "Title" }), (0, skydapp_browser_1.el)("input", { value: link.url, placeholder: "Url" })));
            }
        }
    }
    close() {
