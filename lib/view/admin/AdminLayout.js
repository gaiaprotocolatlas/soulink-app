...
class AdminLayout extends skydapp_common_1.View {
    constructor(params, uri) {
        ...
        skydapp_browser_1.BodyNode.append(this.background = (0, skydapp_browser_1.el)(".background-container"), this.container = (0, skydapp_browser_1.el)(".admin-layout", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("a.background", (0, skydapp_browser_1.el)("i.fa-solid.fa-panorama"), {
        ...
        }), (0, skydapp_browser_1.el)(".menu", this.links["links"] = (0, skydapp_browser_1.el)("a", "Links", { click: () => { skydapp_browser_1.SkyRouter.go("/me", undefined, true); } }), this.links["souls"] = (0, skydapp_browser_1.el)("a", "Souls", { click: () => { skydapp_browser_1.SkyRouter.go("/my/souls", undefined, true); } }), this.links["appearance"] = (0, skydapp_browser_1.el)("a", "Appearance", { click: () => { skydapp_browser_1.SkyRouter.go("/my/appearance", undefined, true); } })), this.saveButton = (0, skydapp_browser_1.el)("a.save", "Save", { click: () => this.save() })), (0, skydapp_browser_1.el)("main", this.profile = (0, skydapp_browser_1.el)(".profile"), this.content = (0, skydapp_browser_1.el)(".content")), (0, skydapp_browser_1.el)("footer", (0, skydapp_browser_1.el)("a", new skydapp_browser_1.ResponsiveImage("img", "/images/logo.png"), {
    ...
    async loadBackground() {
        ...
        if (this.bio.background !== undefined) {
            if (this.bio.cachedBackground !== undefined && this.bio.cachedBackground !== null) {
                ...
                const result = await fetch(`${Config_1.default.apiURI}/background/${this.address}`);
                const str = await result.text();
                if (str !== "") {
