    ...
    async ready(addressOrEns, proc) {
        ...
        if (this.addressOrEns !== addressOrEns) {
            ...
            if (str === "") {
                ...
                this.bio = data.bio;
                this.nfts = data.nfts;
                this.profile.append(new skydapp_browser_1.ResponsiveImage("img", "/images/default-profile.png"), (0, skydapp_browser_1.el)(".name", this.bio.name), (0, skydapp_browser_1.el)(".introduce", this.bio.introduce));
