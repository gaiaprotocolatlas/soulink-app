...
exports.DiscountDBV1__factory = void 0;
...
class DiscountDBV1__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.DiscountDBV1__factory = DiscountDBV1__factory;
DiscountDBV1__factory.bytecode = _bytecode;
DiscountDBV1__factory.abi = _abi;
