...
class BioLinksSetting extends skydapp_common_1.View {
    ...
    async load() {
        await AdminLayout_1.default.current.ready(async () => {
            if (this.closed !== true) {
                AdminLayout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".bio-link-setting-view", this.linkContainer = (0, skydapp_browser_1.el)(".link-container"), this.bar = (0, skydapp_browser_1.el)(".bar"), this.emptyMessage = (0, skydapp_browser_1.el)("p.empty", "This Soul has no external links."), (0, skydapp_browser_1.el)("a.add", (0, skydapp_browser_1.el)("i.fa-regular.fa-plus"), {
                    click: () => {
