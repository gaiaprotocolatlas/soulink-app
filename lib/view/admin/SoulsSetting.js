...
class SoulsSetting extends skydapp_common_1.View {
    ...
    async loadRequestTo(linkedAddresses) {
        ...
        for (const request of requests) {
            ...
            if (isLiked === true) {
                new SoulDisplay_1.default(request.requester, (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("i.fa-solid.fa-link-slash"), {
                    click: async () => {
                ...
                const requestDisplay = new SoulDisplay_1.default(request.requester, (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("i.fa-solid.fa-check"), {
                    click: async () => {
    ...
    async loadRequestFrom(linkedAddresses) {
        ...
        for (const request of requests) {
            ...
            if (isLiked === true) {
                new SoulDisplay_1.default(request.target, (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("i.fa-solid.fa-link-slash"), {
                    click: async () => {
                        await SoulinkContract_1.default.breakLink(await SoulinkContract_1.default.getTokenId(request.target));
                        new Alert_1.default("The transaction has been registered. Please wait until it is finished.");
                    },
                ...
                new SoulDisplay_1.default(request.target, (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("i.fa-solid.fa-link"), {
                    click: async () => {
