            ...
            if (this.closed !== true) {
                        ...
                        if (Layout_1.default.current.currentAddress !== undefined) {
                            ...
                            for (const nft of nfts) {
                                if (this.nftContainer !== undefined) {
                                    const nftDisplay = (0, skydapp_browser_1.el)("a.nft", new NFTDisplay_1.default(nft.image_thumbnail_url), (0, skydapp_browser_1.el)(".name", nft.name === null ? "" : nft.name), { href: nft.permalink, target: "_blank" }).appendTo(this.nftContainer);
                                    nftDisplay.style({ color: Layout_1.default.current.bio.color });
                                }
                            }
                            if (nfts.length < 50) {
                ...
                (async () => {
                    if (Layout_1.default.current.currentAddress !== undefined) {
                        ...
                        if (nfts.length === 0) {
                            this.container?.append((0, skydapp_browser_1.el)("p.empty", "This Soul does not own any NFTs yet."));
                        }
                        if (nfts.length < 50) {
                            loadMoreButton.delete();
                        }
