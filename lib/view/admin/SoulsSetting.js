    ...
    async loadRequest() {
        ...
        for (const request of requests) {
            if (request.requester !== AdminLayout_1.default.current.address) {
                const requestDisplay = new SoulDisplay_1.default(request.bio, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("i.fa-solid.fa-check"), {
                    click: async () => {
                ...
                new SoulDisplay_1.default(request.bio, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a.link", (0, skydapp_browser_1.el)("i.fa-solid.fa-link"), {
                    click: async () => {
