...
class AdminLayout extends skydapp_common_1.View {
    constructor() {
        ...
        skydapp_browser_1.BodyNode.append(this.container = (0, skydapp_browser_1.el)(".admin-layout", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("a", "Links", { click: () => { skydapp_browser_1.SkyRouter.go("/admin", undefined, true); } }), (0, skydapp_browser_1.el)("a", "Appearance", { click: () => { skydapp_browser_1.SkyRouter.go("/admin/appearance", undefined, true); } }), (0, skydapp_browser_1.el)("a", "Requests", { click: () => { skydapp_browser_1.SkyRouter.go("/admin/requests", undefined, true); } }), (0, skydapp_browser_1.el)("a", "Save", { click: () => this.save() })), this.content = (0, skydapp_browser_1.el)(".content")));
