...
class Layout extends skydapp_common_1.View {
    constructor(params, uri) {
        ...
        }), (0, skydapp_browser_1.el)(".menu", (0, skydapp_browser_1.el)(".bar", this.dots["links"] = (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)(".dot"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}`, undefined, true) }), this.dots["souls"] = (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)(".dot"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/souls`, undefined, true) }), this.dots["nfts"] = (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)(".dot"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/nfts`, undefined, true) })), (0, skydapp_browser_1.el)("a", "Links", { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}`, undefined, true) }), (0, skydapp_browser_1.el)("a.long", "Linked Souls", { click: () => { skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/souls`, undefined, true); } }), (0, skydapp_browser_1.el)("a", "NFTs", { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/nfts`, undefined, true) })), (0, skydapp_browser_1.el)("a.card", (0, skydapp_browser_1.el)("i.fa-solid.fa-id-card-clip"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/card`, undefined, true) })), (0, skydapp_browser_1.el)("main", this.profile = (0, skydapp_browser_1.el)(".profile"), this.content = (0, skydapp_browser_1.el)(".content")), (0, skydapp_browser_1.el)("footer", (0, skydapp_browser_1.el)("a", new skydapp_browser_1.ResponsiveImage("img", "/images/logo.png"), {
