...
class AdminLayout extends skydapp_common_1.View {
    constructor(params, uri) {
        ...
        skydapp_browser_1.BodyNode.append(this.background = (0, skydapp_browser_1.el)(".background-container"), this.container = (0, skydapp_browser_1.el)(".admin-layout", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("a.back", (0, skydapp_browser_1.el)("i.fa-light.fa-arrow-left"), { click: () => history.back() }), (0, skydapp_browser_1.el)(".menu", this.links["links"] = (0, skydapp_browser_1.el)("a", "Links", { click: () => { skydapp_browser_1.SkyRouter.go("/me", undefined, true); } }), this.links["souls"] = (0, skydapp_browser_1.el)("a", "Souls", { click: () => { skydapp_browser_1.SkyRouter.go("/my/souls", undefined, true); } }), this.links["appearance"] = (0, skydapp_browser_1.el)("a", "Appearance", { click: () => { skydapp_browser_1.SkyRouter.go("/my/appearance", undefined, true); } })), this.saveButton = (0, skydapp_browser_1.el)("a.save", "Save", { click: () => this.save() })), (0, skydapp_browser_1.el)("main", (0, skydapp_browser_1.el)("a.background", (0, skydapp_browser_1.el)("i.fa-solid.fa-panorama"), {
