...
class Layout extends skydapp_common_1.View {
    constructor(params, uri) {
        ...
        }), this.menu = (0, skydapp_browser_1.el)(".menu", (0, skydapp_browser_1.el)(".bar", this.dots["links"] = (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)(".dot"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}`, undefined, true) }), this.dots["souls"] = (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)(".dot"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/souls`, undefined, true) }), this.dots["nfts"] = (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)(".dot"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/nfts`, undefined, true) })), (0, skydapp_browser_1.el)("a", "Links", { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}`, undefined, true) }), (0, skydapp_browser_1.el)("a.long", "Linked Souls", { click: () => { skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/souls`, undefined, true); } }), (0, skydapp_browser_1.el)("a", "NFTs", { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/nfts`, undefined, true) })), this.dots["card"] = (0, skydapp_browser_1.el)("a.card", (0, skydapp_browser_1.el)("i.fa-solid.fa-id-card-clip"), { click: () => skydapp_browser_1.SkyRouter.go(`/${this.addressOrEns}/card`, undefined, true) }), this.shareButton = (0, skydapp_browser_1.el)("a.share", (0, skydapp_browser_1.el)("i.fa-solid.fa-share-nodes"), {
            click: () => navigator.share({ url: `https://soul.ink/${this.addressOrEns}` }),
        })), (0, skydapp_browser_1.el)("main", this.profile = (0, skydapp_browser_1.el)(".profile"), this.content = (0, skydapp_browser_1.el)(".content")), (0, skydapp_browser_1.el)("footer", (0, skydapp_browser_1.el)("a", new skydapp_browser_1.ResponsiveImage("img", "/images/logo.png"), {
                        ...
                        const acceptButton = (0, skydapp_browser_1.el)("a.accept-soulink-button", "Accept Soulink", {
                            click: async () => {
                                ...
                                const signature = await Wallet_1.default.signTypedData(walletAddress, "Soulink", "1", SoulinkContract_1.default.address, "RequestLink", [
                                    ...
                                    targetId: ethers_1.BigNumber.from(this.currentAddress).toString(),
                                    deadline,
                                });
