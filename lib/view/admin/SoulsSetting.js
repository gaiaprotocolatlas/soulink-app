    ...
    async loadRequest(linked) {
        ...
        for (const request of requests) {
            if (request.accept === undefined &&
                ...
                const soulDisplay = new SoulDisplay_1.default(request.bio ?? { id: request.target, links: [] }, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a.link", (0, skydapp_browser_1.el)("i.fa-solid.fa-link"), {
                    click: async () => {
