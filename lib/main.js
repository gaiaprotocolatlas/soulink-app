...
const LinkRequests_1 = __importDefault(require("./view/admin/LinkRequests"));
...
const Soulmates_1 = __importDefault(require("./view/Soulmates"));
(async () => {
    ...
    skydapp_browser_1.SkyRouter.route("{addressOrEns}/soulmates", Soulmates_1.default);
    ...
    skydapp_browser_1.SkyRouter.route("admin/requests", LinkRequests_1.default);
    skydapp_browser_1.SkyRouter.route([
