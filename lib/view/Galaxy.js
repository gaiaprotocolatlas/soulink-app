...
cytoscape_1.default.use(require("cytoscape-fcose"));
class Galaxy extends skydapp_common_1.View {
    constructor(params) {
        super();
        skydapp_browser_1.BodyNode.append(this.container = (0, skydapp_browser_1.el)(".galaxy-view", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("a.back", (0, skydapp_browser_1.el)("i.fa-light.fa-arrow-left"), { click: () => history.back() }), (0, skydapp_browser_1.el)("h1", "Soul Galaxy")), this.galaxyContainer = (0, skydapp_browser_1.el)(".galaxy-container")));
        ...
        if (addressOrEns !== undefined) {
            ...
            if (addressOrEns.indexOf("0x") === 0) {
                ...
                if (cachedAddress !== "") {
                    ...
                    const _address = await NetworkProvider_1.default.resolveName(addressOrEns);
                    if (_address !== null) {
                        address = _address;
                    }
                }
