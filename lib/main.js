...
(async () => {
    ...
    skydapp_common_1.SkyRouter.route("", Intro_1.default);
    skydapp_common_1.SkyRouter.route("mint", Mint_1.default);
    skydapp_common_1.SkyRouter.route(["{addressOrEns}", "{addressOrEns}/links"], BioLinks_1.default, ["mint", "admin", "admin/links", "owner"]);
    skydapp_common_1.SkyRouter.route("{addressOrEns}/nfts", NFTs_1.default);
    skydapp_common_1.SkyRouter.route("{addressOrEns}/galaxy", Galaxy_1.default);
    skydapp_common_1.SkyRouter.route(["admin", "admin/links"], BioLinksSetting_1.default);
    skydapp_common_1.SkyRouter.route("admin/nfts", NFTsSetting_1.default);
    skydapp_common_1.SkyRouter.route("admin/appearance", AppearanceSetting_1.default);
    skydapp_common_1.SkyRouter.route("admin/analytics", Analytics_1.default);
    skydapp_common_1.SkyRouter.route(["owner", "owner/discount"], DiscountSetting_1.default);
})();
