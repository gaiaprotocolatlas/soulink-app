...
class BioLinksSetting extends skydapp_common_1.View {
    ...
    async load() {
        await AdminLayout_1.default.current.ready(async () => {
            if (this.closed !== true) {
                AdminLayout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".bio-link-setting-view", this.linkContainer = (0, skydapp_browser_1.el)(".link-container"), this.bar = (0, skydapp_browser_1.el)(".bar"), (0, skydapp_browser_1.el)("a.add", (0, skydapp_browser_1.el)("i.fa-solid.fa-plus"), {
                    click: () => {
    ...
    showLinks() {
        if (this.linkContainer !== undefined) {
            ...
            for (const link of AdminLayout_1.default.current.bio.links) {
                const linkDisplay = (0, skydapp_browser_1.el)(".link", (0, skydapp_browser_1.el)("input", { value: link.title, placeholder: "Title" }, { keyup: (event) => { link.title = event.target.value; AdminLayout_1.default.current.checkChanges(); } }), (0, skydapp_browser_1.el)("input", { value: link.url, placeholder: "URL" }, { keyup: (event) => { link.url = event.target.value; AdminLayout_1.default.current.checkChanges(); } }), (0, skydapp_browser_1.el)("a.handle", (0, skydapp_browser_1.el)("i.fa-solid.fa-grip-vertical"), {
                    mousedown: () => {
