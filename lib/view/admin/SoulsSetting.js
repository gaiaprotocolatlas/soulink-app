...
class SoulsSetting extends skydapp_common_1.View {
    ...
    async loadLinked() {
        ...
        for (const bio of bios) {
            new SoulDisplay_1.default(bio, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a.unlink", (0, skydapp_browser_1.el)("i.fa-solid.fa-link-slash"), {
                click: async () => {
    ...
    async loadRequest() {
        ...
        for (const request of requests) {
            if (request.accept === undefined && request.requester !== AdminLayout_1.default.current.address) {
                const requestDisplay = new SoulDisplay_1.default(request.bio ?? { id: request.requester, links: [] }, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("i.fa-solid.fa-check"), {
                    click: async () => {
                    ...
                    click: async () => {
                        ...
                        const loading = new Loading_1.default("Canceling...").appendTo(this.container);
            ...
            else if (request.accept !== undefined && request.requester === AdminLayout_1.default.current.address) {
                new SoulDisplay_1.default(request.bio ?? { id: request.target, links: [] }, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a.link", (0, skydapp_browser_1.el)("i.fa-solid.fa-link"), {
                    click: async () => {
