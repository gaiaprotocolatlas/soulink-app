...
class SoulsSetting extends skydapp_common_1.View {
        ...
        await AdminLayout_1.default.current.ready(async () => {
            if (this.closed !== true) {
                ...
                (async () => {
                    ...
                    const linkedAddresses = await result.json();
                    for (const address of linkedAddresses) {
                        new SoulDisplay_1.default(address, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a.unlink", (0, skydapp_browser_1.el)("i.fa-solid.fa-link-slash"), {
                            click: async () => {
                                await SoulinkContract_1.default.breakLink(await SoulinkContract_1.default.getTokenId(address));
    ...
    async loadRequestTo(linkedAddresses) {
        ...
        for (const request of requests) {
            if (linkedAddresses.includes(request.requester) !== true && request.accept === undefined) {
                const requestDisplay = new SoulDisplay_1.default(request.requester, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("i.fa-solid.fa-check"), {
                    click: async () => {
    ...
    async loadRequestFrom(linkedAddresses) {
        ...
        for (const request of requests) {
            if (linkedAddresses.includes(request.target) !== true && request.accept !== undefined) {
                new SoulDisplay_1.default(request.target, AdminLayout_1.default.current.bio.color, (0, skydapp_browser_1.el)("a.link", (0, skydapp_browser_1.el)("i.fa-solid.fa-link"), {
                    click: async () => {
