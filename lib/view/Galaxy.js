...
class Galaxy extends skydapp_common_1.View {
    constructor(params) {
        super();
        skydapp_browser_1.BodyNode.append(this.container = (0, skydapp_browser_1.el)(".galaxy-view", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("a.back", (0, skydapp_browser_1.el)("i.fa-light.fa-arrow-left"), { click: () => skydapp_browser_1.SkyRouter.go("/", undefined, true) }), (0, skydapp_browser_1.el)("h1", "Soul Galaxy")), this.galaxyContainer = (0, skydapp_browser_1.el)(".galaxy-container")));
        this.load();
    }
    async load() {
