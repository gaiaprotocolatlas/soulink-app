        ...
        this.append(this.content = (0, skydapp_browser_1.el)(".select-nft-popup", (0, skydapp_browser_1.el)("h1", "Select NFT"), this.main = (0, skydapp_browser_1.el)("main", this.nftContainer = (0, skydapp_browser_1.el)(".nft-container"), this.loadMoreButton = (0, skydapp_browser_1.el)("a.load-more", "Load More", {
            click: async () => {
                ...
                for (const nft of nfts) {
                    this.nftDisplays[`${nft.asset_contract.address}-${nft.token_id}`] = (0, skydapp_browser_1.el)("a.nft", new NFTDisplay_1.default(nft.image_thumbnail_url), (0, skydapp_browser_1.el)(".name", nft.name === null ? "" : nft.name), { click: () => this.onNFT(nft.asset_contract.address, nft.token_id) }).appendTo(this.nftContainer);
                }
                if (nfts.length < 50) {
