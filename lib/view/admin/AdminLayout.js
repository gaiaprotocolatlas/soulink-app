            ...
            if (address === undefined) {
                ...
                if (balance.eq(0)) {
                    ...
                    (async () => {
                        ...
                        name.indexOf("0x") === 0 ? skydapp_common_1.SkyUtil.shortenAddress(name) : name;
                        (0, skydapp_browser_1.el)(".name", name).appendTo(this.profile);
                    })();
    ...
    async loadPFP() {
        if (this.imageContainer !== undefined) {
            if (this.bio.pfp !== undefined) {
                ...
                this.imageContainer.append(new PFPDisplay_1.default(this.bio.pfp.address, this.bio.pfp.tokenId));
            }
            else {
