...
class BioLinks extends skydapp_common_1.View {
    ...
    async load(addressOrEns) {
        if (await Layout_1.default.current.ready(addressOrEns) === true) {
            if (this.closed !== true) {
                ...
                for (const link of Layout_1.default.current.bio.links) {
                    this.linkContainer.append((0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)(".title", link.title), { href: link.url }));
                }
            }
        }
    }
