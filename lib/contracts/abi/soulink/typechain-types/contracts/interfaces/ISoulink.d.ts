...
export interface ISoulinkInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DOMAIN_SEPARATOR" | "balanceOf" | "breakLink" | "burn" | "cancelLinkSig" | "getTokenId" | "isLinked" | "isMinter" | "mint" | "name" | "ownerOf" | "setLink" | "supportsInterface" | "symbol" | "tokenURI" | "totalSupply"): FunctionFragment;
...
export interface ISoulink extends BaseContract {
    ...
    functions: {
        ...
        isMinter(target: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        isMinter(target: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        mint(to: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isMinter(target: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        mint(to: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=ISoulink.d.ts.map