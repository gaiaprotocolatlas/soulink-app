            ...
            if (this.closed !== true) {
                ...
                (async () => {
                    ...
                    for (const address of linkedAddresses) {
                        new SoulDisplay_1.default(address, (0, skydapp_browser_1.el)("a.unlink", (0, skydapp_browser_1.el)("i.fa-solid.fa-link-slash"), {
                            click: async () => {
    ...
    async loadRequestFrom(linkedAddresses) {
        ...
        for (const request of requests) {
            if (linkedAddresses.includes(request.target) !== true && request.accept !== undefined) {
                new SoulDisplay_1.default(request.target, (0, skydapp_browser_1.el)("a.link", (0, skydapp_browser_1.el)("i.fa-solid.fa-link"), {
                    click: async () => {
