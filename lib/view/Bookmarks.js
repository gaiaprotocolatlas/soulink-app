...
class Bookmarks extends skydapp_common_1.View {
    constructor(params) {
        super();
        skydapp_browser_1.BodyNode.append(this.container = (0, skydapp_browser_1.el)(".bookmarks-view", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("a.back", (0, skydapp_browser_1.el)("i.fa-light.fa-arrow-left"), { click: () => history.back() }), (0, skydapp_browser_1.el)("h1", "Bookmarks")), this.bookmarkList = (0, skydapp_browser_1.el)(".bookmark-list")));
        this.load();
    }
    async load() {
        if (BookmarkManager_1.default.all.length === 0) {
            this.container.append((0, skydapp_browser_1.el)("p.empty", "You have no bookmarked Souls."));
        }
        else {
