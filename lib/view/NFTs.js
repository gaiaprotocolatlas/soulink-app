        ...
        await Layout_1.default.current.ready(addressOrEns, async () => {
            if (this.closed !== true) {
                ...
                Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".nfts-view", this.nftContainer = (0, skydapp_browser_1.el)(".nft-container"), loadMoreButton = (0, skydapp_browser_1.el)("a.load-more", "Load More", {
                    click: async () => {
                        const loading = (0, skydapp_browser_1.el)(".loading").appendTo(this.container);
                            ...
                            if (nfts.length === 0) {
                                ...
                                for (const nft of nfts) {
                                    if (nft.cached_file_url !== null) {
                                        this.nftContainer.append((0, skydapp_browser_1.el)("a.nft", new NFTDisplay_1.default(nft.cached_file_url), (0, skydapp_browser_1.el)(".name", nft.name === null ? "" : nft.name), { href: `https://opensea.io/assets/${nft.contract_address}/${nft.token_id}`, target: "_blank" }));
                                    }
                                }
                            }
                        }
